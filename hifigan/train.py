...
def train(rank, a, h):
    ...
    print("Creating MPD and MSD")
    generator = Generator(h).to(device)
    mpd = MultiPeriodDiscriminator().to(device)
    msd = MultiScaleDiscriminator().to(device)
    print("Created MPD and MSD")
    if rank == 0:
        print(generator)
...
def main():
    ...
    parser.add_argument('--input_training_file', default='filenames/training.txt')
    parser.add_argument('--input_validation_file', default='filenames/validation.txt')
    parser.add_argument('--checkpoint_path', default='cp_hifigan/GTA')
    ...
    os.environ['CUDA_VISIBLE_DEVICES'] = h.mig_device
